...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    ROSE_GOLD("rose_gold", 10, new int[]{2, 5, 8, 3}, 33, SoundEvents.ARMOR_EQUIP_GOLD,
        2.0F, 0.0F, () -> Ingredient.of(ModItems.ROSE_GOLD_INGOT.get()));
    ...
    public String getName() {
        return pinkExpansion.MOD_ID + ":" + this.name;
    }
