package com.robertorange.pinkexpansion.entity;
...
public class ModBoat extends Boat {
    ...
    public ItemStack getPickedResult(HitResult target) {
        return new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation(pinkExpansion.MOD_ID, this.getWoodType() + "_boat")));
    }
